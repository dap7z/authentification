...
//Invites :
$app->group('',function () {
	//$app->group(['namespace' => 'Auth'], ... renvoi une erreur car converti en chaine (était valable pour slim v2 uniquement?)
	//namespace \App\Controllers\Auth;		//OK DANS CLOSURE SLIM V3 ? pas tel quel en tout cas
	//on passe le namespace en chaine de caractere...
	//nouveau probleme : http://dapo/Auth/auth/signout
...
$app->group('',function () {
	$this->get('/users/list','UsersController:getList')->setName('users.getlist');
	$this->post('/users/list','UsersController:setList')->setName('users.setlist');
